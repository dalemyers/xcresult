...
# This file exhaustively covers every generated model class, mirroring the
# autogenerated xcresult/model.py which disables the same check.
...
def test_all_classes_type_inequality():
    ...
    for class_name in classes_to_test:
        ...
        # Test inequality with different types. These deliberately compare against
        # values of other types to exercise the isinstance guard in __eq__.
...
def test_xchash_members_call_none():
    ...
    class TestObj:
        """Object whose _members attribute is None rather than callable."""
